...
const SignupPage = () => {
  ...
  const validationSchema = yup.object().shape({
    ...
    password: yup
      ...
      .min(8, 'Password too short! Must be 8 characters')
  ...
  const onSignupSubmit = async (values) => {
    const isSignedup = await dispatch(signup(values.name, values.email, values.password));
      ...
      <div className='sup'>
        ...
        >
          {({ values, touched, isValid, dirty, errors, handleChange, handleBlur, handleSubmit, isSubmitting }) => {
            return (
              <form class='sup-form' onSubmit={handleSubmit}>
                <div className='sup-title'>Sign Up</div>

                <div className='sup-input-outer-container'>
                  <div className={`sup-input-container${touched.name && errors.name ? ' error' : ''}`}>
                  ...
                  {touched.name && errors.name && <div className='form-error-inline-text'>{errors.name}</div>}
                </div>

                <div className='sup-input-outer-container'>
                  <div className={`sup-input-container${touched.email && errors.email ? ' error' : ''}`}>
                ...
                <div className='sup-input-outer-container'>
                  <div className={`sup-input-container${touched.password && errors.password ? ' error' : ''}`}>
                    <label className='sup-label' htmlFor='passwordInput'>
                ...
                <div className='sup-input-outer-container'>
                  <div
                    className={`sup-input-container${touched.repeatPassword && errors.repeatPassword ? ' error' : ''}`}
                  >
                    <label className='sup-label' htmlFor='passwordInput'>
