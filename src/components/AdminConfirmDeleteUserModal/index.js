...
import './AdminConfirmDeleteUserModal.css';

const AdminConfirmDeleteUserModal = ({ userId, closeModal }) => {
      ...
      {userDetails && (
        <>
          ...
          <div className='acdum-footer'>
            <button className='admin-table-delete-button acdum-footer-delete-button' onClick={handleClickDelete}>
              Delete
            </button>
...
export default AdminConfirmDeleteUserModal;
